...
Response:
{
  ...
  "fileUrl": "http://192.168.100.61:9005/api/files/audio-files/abc-123.mp3",
...
Response:
{
  ...
  "fileUrl": "http://192.168.100.61:9005/api/files/images/def-456.jpg",
...
Response:
{
  ...
  "zipFileUrl": "http://192.168.100.61:9005/api/files/compressed/xyz-789.zip",
...
file:
  upload-dir: /uploads
  base-url: http://192.168.100.61:9005
```
...
```bash
curl http://192.168.100.61:9005/actuator/health
```
...
curl -H "Range: bytes=1000-" http://192.168.100.61:9005/api/files/audio-files/song.mp3
...
```
http://192.168.100.61:8080/api/files/upload/audio
...
**Health**: http://192.168.100.61:9005/actuator/health
