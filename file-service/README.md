...
Response:
{
  ...
  "fileUrl": "http://localhost:9005/api/files/audio-files/abc-123.mp3",
...
Response:
{
  ...
  "fileUrl": "http://localhost:9005/api/files/images/def-456.jpg",
...
Response:
{
  ...
  "zipFileUrl": "http://localhost:9005/api/files/compressed/xyz-789.zip",
...
curl -H "Range: bytes=1000-" http://localhost:9005/api/files/audio-files/song.mp3
...
```
http://localhost:8080/api/files/upload/audio
...
**Health**: http://localhost:9005/actuator/health
